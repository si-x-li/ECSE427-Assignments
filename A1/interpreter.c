...
int interpret(linked_list *list, char **parsed_words, int num_of_words) {
	...
	if (strcmp(parsed_words[0], "quit") == 0) {
		 ...
		 * ------------------------------------------------------------
		 */
		return print_var(list, parsed_words, num_of_words);
	} else if (strcmp(parsed_words[0], "run") == 0) {
		/* ------------------------------------------------------------
		 * Handles run command
		 * ------------------------------------------------------------
		 */
		return run(list, parsed_words, num_of_words);
	} else if (strcmp(parsed_words[0], "set") == 0) {
		/* ------------------------------------------------------------
		 * Handles set command
		 * ------------------------------------------------------------
		 */
		return set_var(list, parsed_words, num_of_words);
	} else {
		/* ------------------------------------------------------------
 ...
 *        input  - parsed_words  An array of strings
